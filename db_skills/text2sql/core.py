...
from db_skills.text2sql.examples import ExampleStore
from db_skills.text2sql.generate import SQLGenerator, SQLResult
...
class TextSQL:
    ...
    def __init__(
        ...
        model: str = None,  # None = 用项目 config 的 LLM 配置
    ...
    def analyze(self, trace_file: str | None = None):
        ...
        """
        from db_skills.text2sql.analyze import AnalysisEngine
        ...
        if trace_file:
            ...
            from db_skills.text2sql.models import AnalysisReport
